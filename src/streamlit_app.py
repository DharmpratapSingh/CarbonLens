        ...
        with st.spinner("🔄 Processing your question..."):
            try:
                ...
                if answer_start != -1:
                    ...
                    st.error("❌ Could not extract answer from response")
                ...
                st.error("❌ Request timed out (>120 seconds). Please try a simpler question.")
            except FileNotFoundError:
                st.error("❌ Could not find run_llm.py. Make sure you're running this from the correct directory.")
